...
class Gym_env():
    ...
    def step(self, rl_actions):
        ...
        self.update()
        # print("forces:", ',     '.join(f'{q:.2f}' for q in self.piper_forces ))
        # print("actions")
        # print(', '.join(f'{q:.2f}' for q in rl_actions))
    ...
    def get_states(self):
        ...
        joint_angles[:]             = self.piper_dof_states['pos'][:]  #list(8) 
        joint_velocities[:]         = self.piper_dof_states['vel'][:]  #list(8) 
        ...
        obs = np.array(goal_position + goal_orientation + joint_angles + joint_velocities + end_effector_position + end_effector_orientation + end_effector_velocity, dtype=np.float32)
